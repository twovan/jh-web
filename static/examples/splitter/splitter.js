    ...
    return this.each(function() {
      ...
      if (opts.closeableto != undefined) {
        ...
        Bt.mousedown(function(e) {
          ...
          splitTo(
            splitPos == opts.closeableto ? _splitPos : opts.closeableto,
            true
          )
          return false
        })
      ...
      var perc = (
        ((C.position()[opts.moving] - splitter.offset()[opts.moving]) /
          splitter[opts.sizing]()) *
        100
      ).toFixed(1)
      ...
      function endDrag(e) {
        ...
        var perc = (
          ((p[opts.moving] - splitter.offset()[opts.moving]) /
            splitter[opts.sizing]()) *
          100
        ).toFixed(1)
      ...
      function splitTo(perc, reversedorder, fast) {
        ...
        var barsize =
          C[opts.sizing]() +
          2 * parseInt(C.css('border-' + opts.moving + '-width')) // + border. cehap&dirty
